...
const MultiUAVStatus = ({ uavs, loading, masterUAVId }) => {
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        {uavs.map((uav) => {
          ...
          <div 
            key={uav.uavId} 
            style={{
              border: isMaster ? '3px solid #fbbf24' : '1px solid #e5e7eb',
              borderRadius: '8px',
              padding: '1rem',
              backgroundColor: isMaster ? '#fffbeb' : '#f9fafb',
              boxShadow: isMaster ? '0 4px 6px -1px rgba(251, 191, 36, 0.3)' : 'none',
              position: 'relative'
            }}
          >
            {/* Master Badge */}
