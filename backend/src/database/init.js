...
async function createTables(db) {
    const tables = [
        ...
        // Slave data transmissions table
    ...
    const indexes = [
        ...
        'CREATE INDEX IF NOT EXISTS idx_slave_master ON slave_data_transmissions(master_uav_id)',
        'CREATE INDEX IF NOT EXISTS idx_slave_id ON slave_data_transmissions(slave_uav_id)',
        'CREATE INDEX IF NOT EXISTS idx_slave_timestamp ON slave_data_transmissions(timestamp)'
    ];
