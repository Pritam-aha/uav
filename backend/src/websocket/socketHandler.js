...
const socketHandler = (io) => {
    ...
    io.broadcastMasterDroneChanged = (masterData) => {
        io.emit('master_drone_changed', masterData);
    };

    io.broadcastSlaveDataReceived = (slaveData) => {
        io.emit('slave_data_received', slaveData);
    };

    io.broadcastMasterAggregatedData = (aggregatedData) => {
        io.emit('master_aggregated_data', aggregatedData);
    };
